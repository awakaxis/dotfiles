...
alias nanorc="vim ~/.bashrc"
alias nanoz="vim ~/.wezterm.lua"
alias awakaxis@pi="ssh awakaxis@192.168.1.15"
alias venvpy="venv/Scripts/python"
...
alias ccs="cd ~/Documents/dev/minecraft/'minecraft java modding'/cc-schtuff"
alias uno="cd ~/Documents/dev/minecraft/'minecraft java modding'/'uno mod'"
